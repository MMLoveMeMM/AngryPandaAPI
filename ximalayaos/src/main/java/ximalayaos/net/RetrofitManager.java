...
public class RetrofitManager {
     ...
     * 服务器地址
     */
    private static final String API_HOST = "https://api.ximalaya.com";//"https://v.juhe.cn";

    public static final MediaType RETROFIT_JSON = MediaType.parse("application/json; charset=utf-8");

    private static XiMaLayaOsService service;
    private static Retrofit retrofit;

    public static XiMaLayaOsService getService() {
        if (service == null) {
            service = getRetrofit().create(XiMaLayaOsService.class);
        }
        return service;
    }
