...
public class Tracks {
    ...
    private long play_size_64_m4a;
    private String play_url_24_m4a;
    private long play_size_24_m4a;
    private String play_url_amr;
    private long play_size_amr;
    ...
    public void setPlay_size_64_m4a(long play_size_64_m4a) {
         this.play_size_64_m4a = play_size_64_m4a;
     }
     public long getPlay_size_64_m4a() {
    ...
    public void setPlay_size_24_m4a(long play_size_24_m4a) {
         this.play_size_24_m4a = play_size_24_m4a;
     }
     public long getPlay_size_24_m4a() {
    ...
    public void setPlay_size_amr(long play_size_amr) {
         this.play_size_amr = play_size_amr;
     }
     public long getPlay_size_amr() {
    ...
    public void setContain_video(boolean contain_video) {
     ...
     public boolean getContain_video() {
