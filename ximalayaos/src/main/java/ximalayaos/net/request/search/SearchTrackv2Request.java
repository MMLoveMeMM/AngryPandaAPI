...
import ximalayaos.net.model.searchtrackv2.SearchTrackv2Bean;
 ...
 * @ClassName: SearchTrackv2Request
 * @Author: 刘志保
 * @CreateDate: 2019/9/17 18:02
 * @Description: java类作用描述
 */
public class SearchTrackv2Request {

    private static final String TAG = SearchTrackv2Request.class.getName();

    public static void httpSearchTrackv2Request(Context context,final IRequest iRequest){
    ...
    public static void httpSearchTrackv2Request(Context context,long id,String title,long uid,
    ...
    public static void httpRequest(Map<String, String> paramsMap, final IRequest iRequest){
        ...
        try {
            call = RetrofitManager.getService().getSearchTrackv2List(paramsMap);
                ...
                public void onResponse(Call<ResponseBody> call,Response<ResponseBody> response) {
                    ...
                    try {
                        if (response != null && response.body() != null) {
                             ...
                             */
                            Gson gson = new Gson();
                            SearchTrackv2Bean bean = gson.fromJson(rawJson,SearchTrackv2Bean.class);

                            if (iRequest != null) {
                                iRequest.callBackRequestBean(bean);
                            }
                            Log.e("PostTest", "search tracks v2 ----> : " + bean.getTracks().get(0).getTrack_intro());
                        }
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
